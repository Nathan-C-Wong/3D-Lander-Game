...
public:
	...
	void draw(TreeNode & node, int numLevels, int level, vector<ofColor>& levelColours);
	void draw(int numLevels, int level, vector<ofColor>& levelColours) {
		draw(root, numLevels, level, levelColours);
	}
